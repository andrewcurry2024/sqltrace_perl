...
create database sql_hist in appdbs01 with buffered log;
...
{ TABLE "informix".query_sample row size = 39 number of columns = 8 index size = 48 }
...
create table "informix".query_sample 
  (
    ...
    max_execution_time decimal(10,5),
    min_execution_time decimal(10,5),
...
{ TABLE "informix".query_plan row size = 16 number of columns = 3 index size = 0 }

create table "informix".query_plan 
  (
    query_id integer,
    explain_id integer,
    timestamp datetime year to second
...
revoke all on "informix".query_plan from "public" as "informix";
...
grant select on "informix".query_plan to "public" as "informix";
grant update on "informix".query_plan to "public" as "informix";
grant insert on "informix".query_plan to "public" as "informix";
grant delete on "informix".query_plan to "public" as "informix";
grant index on "informix".query_plan to "public" as "informix";
